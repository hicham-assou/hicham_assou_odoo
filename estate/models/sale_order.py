...
class SaleOrder(models.Model):
    ...
    def action_confirm(self):
        # Vérifiez le niveau de gestionnaire requis avant de confirmer la commande de vente
        self._check_required_manager_level()
        if self.required_manager_level > self.env.user.manager_level:
            raise exceptions.UserError(
                "Vous n'avez pas le niveau de gestionnaire requis pour confirmer cette commande de vente.")
